...
// Constants
const TWITTER_HANDLE = 'arpitingle';
  ...
  if (!currentAccount) {
    return (
      <div className="connect-wallet-container">
        <img
          src="https://c.tenor.com/nuaLJOCwH7gAAAAC/madara-eyes.gif"
  ...
  <div className="App">
    <div className="container">
      <div className="header-container">
        <p className="header gradient-text">4th Great Ninja War</p>
        <p className="sub-text">Team up to protect the Village!</p>
